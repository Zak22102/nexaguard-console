...
const heroStats = [
  ...
  { value: "< 1s", label: "Responstid" },
  { value: "500+", label: "Virksomheder" },
...
const integrations = [
  { name: "Microsoft 365", icon: Server },
  { name: "Google Workspace", icon: Globe },
  { name: "Slack", icon: MessageSquare },
  { name: "Linux/Windows", icon: Database },
];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -left-4 bottom-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
      ...
      <section className="py-12 border-t border-border bg-card/30">
        <div className="container mx-auto px-4">
          <p className="text-center text-sm text-muted-foreground mb-8">Betroet af førende danske virksomheder</p>
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-50">
            {['TechCorp', 'Nordic Bank', 'DanMed', 'ScandRetail', 'EuroFinance'].map((company, i) => (
              <div key={i} className="font-heading text-xl font-bold text-muted-foreground">{company}</div>
            ))}
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="flex flex-col items-center text-center p-8 rounded-xl bg-card border border-border hover:border-primary/30 transition-all duration-300 group"
              >
      ...
      <section className="py-20 border-t border-border bg-card/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { step: "1", title: "Opret konto", description: "Tilmeld jer og konfigurer jeres workspace på få minutter." },
              { step: "2", title: "Forbind systemer", description: "Integrer med Microsoft 365, Google Workspace og mere." },
              { step: "3", title: "AI analyserer", description: "Vores AI begynder straks at analysere jeres sikkerhedsdata." },
              { step: "4", title: "Få indsigter", description: "Modtag handlingsorienterede anbefalinger og rapporter." },
            ].map((item, index) => (
              ...
              <Card className="relative">
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="space-y-3">
                    {[
                      { name: "Microsoft 365", status: "Connected", logs: "12,847" },
                      { name: "Google Workspace", status: "Connected", logs: "8,234" },
                      { name: "Slack", status: "Pending", logs: "-" },
                    ].map((item, index) => (
